        ...
        for document in result[0:]:
            ...
            for element in noPuncAllLower:
              if element not in currentDocumentDictionary: # word is not registered in current dictionary
                ...
                currentDocumentDictionary[element] = [[positionFound], 1 ]
              else: #word is already registered in current dictionary
                # add new position where same word has been found
                currentDocumentDictionary[element][0].append(positionFound)
                #update frequenct
            ...
            documentNumberDictionary[docno] = [len(lenWithoutStopWords), len(noDuplicateDictionary), noDuplicateDictionary]

            # print (docno)
            # print(noPuncAllLower)
            # print(noDuplicateDictionary)

print(documentNumberDictionary["AP890101-0001"])
